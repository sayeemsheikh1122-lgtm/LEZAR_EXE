...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // email input removed (whitelist disabled)
  updateStats();
  // ensure history card visible if there are items
  if (historyItems.length > 0) document.getElementById('historyCard').style.display = 'block';
});
...
(function () {
  ...
  function init() { resize(); particles = Array.from({ length: 160 }, mkP); }
